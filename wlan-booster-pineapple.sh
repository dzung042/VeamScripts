...
#
wifidev="${WIFI}"
txpowerb=$(iwconfig $wifidev | awk '{ print $5 }' | head -n 2)
#
echo " "
...
#
sleep 2
txpowera=$(iwconfig $wifidev | awk '{ print $5 }' | head -n 2)
echo -e "Switched from \e[34m$txpowerb\e[0m" 
echo -e "to \e[34m$txpowera\e[0m"
echo " "
echo " "
sleep 2